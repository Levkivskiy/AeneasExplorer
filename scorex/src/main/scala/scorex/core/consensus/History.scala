...
trait History[PM <: mainviews.PersistentNodeViewModifier, SI <: SyncInfo, HT <: History[PM, SI, HT]] extends HistoryReader[PM, SI] {
...
object History {
  ...
  /**
    ...
    */
  case class ProgressInfo[PM <: mainviews.PersistentNodeViewModifier](branchPoint: Option[ModifierId],
                                                                      toRemove: Seq[PM],
                                                                      toApply: Option[PM],
